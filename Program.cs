...
builder.Services.AddTransient<DBIngredienteService>();
builder.Services.AddTransient<DBPrecioService>();
builder.Services.AddTransient<DBRecetaService>();
builder.Services.AddTransient<DBOtrosCostosService>();
